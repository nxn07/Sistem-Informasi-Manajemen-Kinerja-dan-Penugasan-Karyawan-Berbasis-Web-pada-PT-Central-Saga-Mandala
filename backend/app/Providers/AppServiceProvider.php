...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(RoleRepositoryInterface::class, RoleRepository::class); // <-- Tambahan Modul Role
        ...
        $this->app->bind(RoleServiceInterface::class, RoleService::class); // <-- Tambahan Modul Role
    }
